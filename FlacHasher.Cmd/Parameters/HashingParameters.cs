...
namespace Andy.FlacHash.Application.Cmd
{
    ...
    {
        [ParameterDescription($"A format in which hash result is presented. Use the following placeholders: {OutputFormatting.Placeholders.Hash}, {OutputFormatting.Placeholders.FileName}, {OutputFormatting.Placeholders.FilePath}")]
